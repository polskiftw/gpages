...
DEFAULT_PROJECT = {
    ...
    "preferences": {
        ...
        "theme": "christmas",
        "hide_spoilers": False,
        "strict_boundary_certification": True,
    },
...
def mapping_snapshot(project: dict) -> dict:
    return {
        ...
        "edition_calibration": project.get("edition_calibration", {}),
        "boundary_nudges": project.get("boundary_nudges", {}),
        "boundary_certifications": project.get("boundary_certifications", {}),
        "subtitle_match_runs": project.get("subtitle_match_runs", {}),
        "subtitle_proposals": project.get("subtitle_proposals", {}),
